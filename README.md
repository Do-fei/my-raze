...
开发版暂用官方示例模型 Hiyori 占位，正式看板娘 `.moc3` 到位后只需替换 `client/public/live2d/official/`。详见 [`client/public/live2d/NOTICE.md`](client/public/live2d/NOTICE.md)、[建模委托清单](docs/live2d/commission-brief.md) 与 [开工后工作说明 / 下一步](docs/PROGRESS.md)。
